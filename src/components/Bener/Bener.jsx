...
const contents = (text, isLoaded) => {
    if (text === '정읍 월드메르디앙' || text === '홍보영상' || text === '체크포인트'| text === '당첨자서류안내') {
        return (
            <>
        ...
        return (
            <>
                ...
                <div className={`${styles.text} ${isLoaded ? styles.showText : ''}`}>
                   정읍 제 1·2 산업단지 및 벤처협동화단지 직주근접  프리미엄
                </div>
                <div className={`${styles.text} ${isLoaded ? styles.showText : ''}`}>
                    가장 높은 브랜드의 첫 시작
                </div>
        ...
        return (
            <>
                ...
                <div className={`${styles.text} ${isLoaded ? styles.showText : ''}`}>
                    기대하던 모든 프리미엄이 정읍 월드메르디앙에서 펼쳐집니다
                </div>
            </>
        );
    } else if (text === '단지안내') {
