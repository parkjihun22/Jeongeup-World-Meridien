  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="59타입의평면 안내 페이지는 정읍 월드메르디앙의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요."
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://intercs.co.kr/FloorPlan/59A"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="정읍 월드메르디앙 - 59타입 평면도" />
        <meta
        ...
        <script type="application/ld+json">
          {`
			...
			"description": "59타입의평면 안내 페이지는 정읍 월드메르디앙의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.",
      ...
      <p className={styles.screenReaderOnly}>
        59타입의평면 안내 페이지는 정읍 월드메르디앙의 각 아파트 평면도를
