  ...
  return (
    <div className={styles.container}>
      <Helmet>
              ...
              {/* SEO 최적화를 위한 메타 태그 */}
              <title>정읍 월드메르디앙 - 세대안내영상</title>
              <meta
                name="description"
                content="세대안내영상 안내 페이지는 정읍 월드메르디앙의 각 아파트 세대안내영상를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요."
              />
              <meta
                name="keywords"
      ...
      <h1 className={styles.screenReaderOnly}>정읍 월드메르디앙 - 세대영상안내</h1>
			<p className={styles.screenReaderOnly}>세대안내영상 안내 페이지는 정읍 월드메르디앙의 각 아파트 세대안내영상를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.
			</p>

			<div className={styles.textBox}>
				<div>정읍의 눈부신 가치위에 찾아오는는</div>
				<div>플래티넘의 가치를 영상으로 확인해보세요</div>
			</div>
