...
const projectData = [
  { label: "사업명", value: "정읍 역세권지구 월드메리디앙 더 브리온" },
  { label: "사업위치", value: "전북특별자치도 정읍시 농소동 127-5번지" },
  { label: "대지면적", value: "19,637.30㎡ " },
  { label: "건축면적", value: "11,851.2990㎡" },
  { label: "연면적", value: "219,201.8244㎡" },
  { label: "용적률", value: " 742.55%" },
  { label: "건축규모", value: "지하 2층, 지상 최고 27층" },
  { label: "세대수", value: "275세대 (84㎡/ 84A-1㎡/84B㎡)" },
];
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>정읍 월드메르디앙 - 사업안내</title>
        <meta
          name="description"
          content="정읍 월드메르디앙은 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="정읍 월드메르디앙 - 사업안내" />
        <meta
          ...
          {`
		{
			...
			"@type": "WebPage",
			"name": "정읍 월드메르디앙 - 사업안내",
			"description": "정읍 월드메르디앙은 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다.",
      ...
      <p className={styles.screenReaderOnly}>
        정읍 월드메르디앙은 혁신적인 주거 환경을 제공하는 새로운 아파트
      ...
      <div className={styles.textBox}>
        <div>
          정읍의 중심상권을  누리는 특별한 라이프 컬렉션
        </div>
        <div>정읍 월드메르디앙의 새로운 자부심으로 찾아옵니다.</div>
      </div>

      <img
        className={styles.img3}
        src={page1}
        alt="정읍 월드메르디앙 메인 조감도 -image1"
      />
