...
const LocationSection = [
  {
    img: section2Image1,
    titleText:
      "확정된 개발호재로<br />정읍을 더 새롭게 살수록 높아지는 미래가치",
    contentText:
      "연축지구, 효자구역 , 회덕IC <br />충청권 광역철도 등 풍부한 미래가치<br />",
  },
  {
    img: section2Image2,
    titleText: "더브리온만의 특화설계 및 쾌적한 단지설계",
    contentText:
  ...
  },
  {
    ...
    contentText:
      "이마트, 하나로마트 , 오정농수산물 시장과<br /> 정읍병원,회덕초등학교 등 편리한 인프라",
  },
  {
    img: section2Image5,
  ...
  },
  {
    img: section2Image6,
    titleText:
      "정읍의 중심<br /> 단지 앞 도서관, <br /> 계족산 공원프리미엄까지  ",
    contentText:
      " 정읍의 중심 핵심주거타운 <br /> 더브리온 프리미엄은 덤으로",
  },
];
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.screenReaderOnly}>
        정읍 월드메르디앙의 입지 안내 페이지는 이 단지의 위치와 주변 인프라에
