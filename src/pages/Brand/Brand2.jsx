  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta property="og:title" content="정읍 월드메르디앙 - 홍보영상" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://intercs.co.kr/Brand/video"
        />
          ...
          {`
															{
																...
																"url": "https://intercs.co.kr/Brand/video"
															}
															`}
        </script>
      </Helmet>
