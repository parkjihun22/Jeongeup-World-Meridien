  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>정읍 월드메르디앙 - 커뮤니티</title>
        <meta
          name="description"
          content="정읍 월드메르디앙의 커뮤니티 페이지에서는 단지 내 다양한 커뮤니티 시설을 소개합니다. 헬스장, 독서실, 카페 등 주민들의 편리한 생활을 위한 다양한 시설들이 준비되어 있습니다. 이러한 시설들이 입주민들의 삶의 질을 높이고, 더 나은 공동체 생활을 만들어주는 역할을 합니다."
        />
        <meta
          name="keywords"
      ...
      <p className={styles.screenReaderOnly}>
        정읍 월드메르디앙의 커뮤니티 페이지에서는 단지 내 다양한 커뮤니티
