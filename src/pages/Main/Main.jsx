...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `정읍 신 주거문화의 새중심`,
    text2: `정읍의 중심 다양한 인프라까지 <br />
           약 2,000세대 주거타운 조성으로<br /> 높은 미래가치`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `빛나는 역세권의 가치`,
    text2: `다양한 개발호재는 물론<br />
          KTX,SRT를 품은<br /> 정읍역 역세권 프리미엄`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img src={mainImage} className={styles.mainImage} alt="정읍 월드메르디앙-mainimage1" />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox}>
              <div className={styles.mainImageTextSub}>
                계약금 2,000만원 <span className={styles.greyText}>정액제</span> | 부담을 덜어주는 <span className={styles.greyText}>발코니 무상</span> | 중도금전액 <span className={styles.greyText}>무이자</span>
              </div>
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>정읍이 기다린 가장 착한 아파트</div>
                <div className={styles.mainImageLine}></div>
                <div className={styles.mainImageText}>정읍 월드메르디앙</div>
              </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 더브리온의 대표 주거 브랜드 '더 플래티넘'에서 선보이는 시그니처 라이프 <br />
                  - 첨단 아주대학교 종합병원 도보 5분 <br />
                  - 정읍 제1·2산업단지 및 벤처협동화 단지 인접 2호선 읍내역(28년예정), 정읍IC로 <br />
                  - 모두를 누리는 정읍 월드메르디앙
                </div>
              ...
              <div className={styles.menuBox}>
                <img src={section1_Image1} alt="정읍 월드메르디앙브랜드소개-image2" />
          ...
          <div className={styles.section}>
            <div className={styles.section8}>
              ...
              <img src={section8Img3} alt="정읍 월드메르디앙입지환경소개-image2" />
            </div>
          </div>
            ...
            <div className={styles.section2}>
              <div className={styles.textBox}>
                ...
                <div className={`${styles.text2} fadeUpRepeat`}>
                  기대한 모든 프리미엄이<br />정읍 월드메르디앙에서 펼쳐집니다
                </div>
              ...
              <img src={section2_Image1} alt="정읍 월드메르디앙아파트 조감도-image3" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="정읍 월드메르디앙브랜드소개-image4" />
                <div className={styles.text1}>정읍 월드메르디앙</div>
...
<div className={styles.pcVisitContainer}>
  ...
  <form
    ...
    action="https://formspree.io/f/xeoawnbr"
    method="POST"
  >
    <label htmlFor="name">
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="정읍 월드메르디앙오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img src={mobileImageMain} className={styles.mainImage} alt="정읍 월드메르디앙mobilemain-image1" />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
              <div className={styles.mainImageTextSub1}>
                계약금 정액제<br />
                <span className={styles.greyText}>2,000만원</span><br />
                부담을 덜어주는<br />
                <span className={styles.greyText}>착한옵션</span><br />
                중도금 전액 <br />
                <span className={styles.greyText}>무이자</span>
              </div>
              <div className={styles.mainImageTitleBox1}>
                <div className={styles.mainImageText1}>정읍이 기다린<br /> 가장 착한 아파트</div>
                <div className={styles.mainImageText5}>정읍 월드메르디앙</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 더브리온의 대표주거 브랜드 정읍에서 선보이는 시그니처 라이프<br />
              - 정읍 아산명원 및 각종 인프라 대거 인접<br />
              - 정읍역 역세권아파트로 KTX,SRT를 품은 정읍 월드메르디앙<br />
              - 모두를 누리는 주거 타운의 완성
            </div>
            <div className={styles.text4}>
              <a href="https://naver.me/55rUFpYq" target="_black">
          ...
          <div className={styles.container7}>
            ...
            <img src={section8Img3} alt="정읍 월드메르디앙mobile입지안내-image1" />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른<br />
                프리미엄 주거라이프를 정읍 월드메르디앙 모델하우스에서 확인하세요
              </div>
            </div>
            <img src={section2_Image1} alt="정읍 월드메르디앙mobile조감도-image1" />
          </div>
...
<div className={styles.mobileVisitContainer}>
  ...
  >
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="정읍 월드메르디앙오시는길안내-mobileimage2" />
            </div>
          </div> */}
